...
| Platform | Status |
|----------|--------|
| Windows | Verified. The development and test machine. |
| macOS, Linux | Unverified. Nothing in the tool is Windows-specific by design, and KiCad resolution is path-based on all three, but no run has been recorded. |
