...
| Board writes | `board route`, `board netclass`, `board rewidth`, `board widen`, `board stitch`, `board move`, `board place` | Routing, netclass targets, trace widening, stitching, movement and automatic placement behind a confirmation gate. Verification and rollback vary by operation and mode; they are not a uniform safety guarantee. |
